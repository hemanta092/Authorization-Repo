...
public class SecurityConfigurer extends WebSecurityConfigurerAdapter {
	...
	protected void configure(AuthenticationManagerBuilder auth) throws Exception {
		log.info("Entering AuthenticationManagerBuider configure method!!!");
		auth.authenticationProvider(authProvider());
		log.info("Exiting AuthenticationManagerBuider configure method!!!");

	}

	@Override
	protected void configure(HttpSecurity http) throws Exception {
		log.info("Entering HttpSecurity configure method!!!");
		...
		log.info("Exiting HttpSecurity configure method!!!");
	}

	@Override
	@Bean
	public AuthenticationManager authenticationManagerBean() throws Exception {
		log.info("Creation of Authentication Manager Bean successful!!!");
		return super.authenticationManagerBean();
	}

	@Override
	public void configure(WebSecurity web) throws Exception {
		log.info("Entering WebSecurity configure method!!!");
		...
		log.info("Exiting WebSecurity configure method!!!");
	}
